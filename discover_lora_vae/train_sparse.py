...
def train(args):
    ...
    def train_step(first=0.4, first_with_orig=0.01, second=0.4, second_w_orig=0.01, noise_std=0.01):
        ...
        recon_x, ground_truth, sparse_logits, sparsity_loss = lora_vae(batch) 
        ...
        return mse_loss, grad_norm, sparse_logits, sparsity_loss


    grad_norm = 0
    for i in range(args.max_train_steps):
        with accelerator.accumulate(lora_vae):
            mse_loss, grad_norm, sparse_logits, sp_loss = train_step() 
